// Copyright (c) 2019-2021 The BitcoinZ developers
...
// CompactSaplingSpend is a Sapling Spend Description as described in 7.3 of the BitcoinZ
...
type CompactSaplingSpend struct {
	...
	Nf []byte `protobuf:"bytes,1,opt,name=nf,proto3" json:"nf,omitempty"` // nullifier (see the BitcoinZ protocol specification)
}
...
// section 7.4 of the BitcoinZ protocol spec:
