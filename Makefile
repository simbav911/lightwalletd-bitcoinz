...
BUILDUSER := `whoami`
LDFLAGSSTRING :=-X github.com/bitcoinz-xyz/lightwalletd/common.Version=$(VERSION)
LDFLAGSSTRING +=-X github.com/bitcoinz-xyz/lightwalletd/common.GitCommit=$(GITCOMMIT)
LDFLAGSSTRING +=-X github.com/bitcoinz-xyz/lightwalletd/common.Branch=$(BRANCH)
LDFLAGSSTRING +=-X github.com/bitcoinz-xyz/lightwalletd/common.BuildDate=$(BUILDDATE)
LDFLAGSSTRING +=-X github.com/bitcoinz-xyz/lightwalletd/common.BuildUser=$(BUILDUSER)
