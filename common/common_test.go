...
func getLightdInfoStub(method string, params []json.RawMessage) (json.RawMessage, error) {
	...
	switch method {
	case "getinfo":
		r, _ := json.Marshal(&BitcoinZdRpcReplyGetinfo{})
		return r, nil
	...
	case "getblockchaininfo":
		...
		r, _ := json.Marshal(&BitcoinZdRpcReplyGetblockchaininfo{
			Blocks:    9977,
			Chain:     "bugsbunny",
...
func TestBitcoinZdRpcReplyUnmarshalling(t *testing.T) {
	var txinfo0 BitcoinZdRpcReplyGetrawtransaction
	...
	var txinfo1 BitcoinZdRpcReplyGetrawtransaction
	...
	var txinfo2 BitcoinZdRpcReplyGetrawtransaction
